class MinHeap {
  // this implementation of MinHeap was adapted from the medium post
  ...
  insert(node) {
    ...
    if (this.heap.length > 1) {
      ...
      /* Traversing up the parent node until the current node (current)
        is greater than the parent (current/2) */
      while (current > 1
